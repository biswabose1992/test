const { generate } = require('./node_modules/multiple-cucumber-html-reporter');
const cucumberJson = require('./node_modules/wdio-cucumberjs-json-reporter');
const multipleCucumberHtmlReporter = require('./node_modules/multiple-cucumber-html-reporter');
//import cucumberJson from 'wdio-cucumberjs-json-reporter';
//remove the report folder before you start all sessions.
...
exports.config = {
    ...
    */
    ...
    cucumberOpts: {
        require: require ('glob').sync('./src/step-definitions/**.js'), 
        ...
        //If you want use import command to import packages/files then  add babble for it
